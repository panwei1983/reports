...
**arXiv 返回**：248 | **初筛命中**：248 | **进入周报**：20
**分类统计**：排序/重排 6 | 推荐系统 7 | 广告系统 3 | LLM/RAG 4
...
- **评分**：6.70（关键词 16.0 + 机构 0.5）| **日期**：2026-07-18 | **[论文链接](https://arxiv.org/abs/2607.16603v1)**
...
#### 2. ⭐ Evidence-in-the-Loop: Trace-Driven Optimization for Customer-Service LLM Agents

- **评分**：5.70（关键词 13.5 + 机构 0.5）| **日期**：2026-07-20 | **[论文链接](https://arxiv.org/abs/2607.18039v1)**
...
- **评分**：5.50（关键词 13.0 + 机构 0.5）| **日期**：2026-07-20 | **[论文链接](https://arxiv.org/abs/2607.18102v1)**
...
#### 4. Optimizing Visibility in Generative Engines: A Critical Survey of Generative Engine Optimization (2023-2026)

- **评分**：5.50（关键词 13.0 + 机构 0.5）| **日期**：2026-07-15 | **[论文链接](https://arxiv.org/abs/2607.14035v1)**
- **作者**：Olivier Martinez
...
#### 10. TMallGS: Scaling Unified Feature and Sequence Modeling for Generative E-commerce Search

- **评分**：4.90（关键词 11.5 + 机构 0.5）| **日期**：2026-07-15 | **[论文链接](https://arxiv.org/abs/2607.13398v1)**
...
#### 11. Learning Sparse Representations of Multimodal Content for Enhanced Cold Item Recommendation

- **评分**：4.68（关键词 10.5 + 机构 0.8）| **日期**：2026-07-19 | **[论文链接](https://arxiv.org/abs/2607.17184v1)**
...
#### 12. LLM-Based Re-Ranking for Real Estate Search

- **评分**：4.50（关键词 10.5 + 机构 0.5）| **日期**：2026-07-16 | **[论文链接](https://arxiv.org/abs/2607.14835v2)**
...
#### 15. TurboVec: A Case Study in Cost-Efficient Private Retrieval for Enterprise RAG via Codebook-Oblivious Quantization

- **评分**：4.48（关键词 10.0 + 机构 0.8）| **日期**：2026-07-18 | **[论文链接](https://arxiv.org/abs/2607.16973v1)**
...
#### 16. Long-History User Transformers for Real-Time Ad Ranking

- **评分**：4.48（关键词 10.0 + 机构 0.8）| **日期**：2026-07-15 | **[论文链接](https://arxiv.org/abs/2607.14331v1)**
...
#### 17. ⭐ Vector Search As Nearest Neighbor Matching: RAG-based Policy Learning in Causal Inference

- **评分**：5.70（关键词 13.5 + 机构 0.5）| **日期**：2026-07-20 | **[论文链接](https://arxiv.org/abs/2607.18225v1)**
...
#### 18. D-NOVA: In-Storage Retrieval Accelerator via Dual-Bound 3D NAND-Optimized Similarity Search with Vector Adaptation

- **评分**：5.28（关键词 12.0 + 机构 0.8）| **日期**：2026-07-20 | **[论文链接](https://arxiv.org/abs/2607.17538v1)**
...
### ⭐ Top 2. NOWJ@COLIEE 2026: Adaptive Pipelines for Legal Retrieval and Reasoning

**论文链接**：[https://arxiv.org/abs/2607.16603v1](https://arxiv.org/abs/2607.16603v1) | **HTML全文**：[https://arxiv.org/html/2607.16603v1](https://arxiv.org/html/2607.16603v1)
...
### ⭐ Top 3. RAMP: Robust Ad Recommendation Under Limited Personalized-Feature Availability via Masking and Alignment Pathways

**论文链接**：[https://arxiv.org/abs/2607.17473v1](https://arxiv.org/abs/2607.17473v1) | **HTML全文**：[https://arxiv.org/html/2607.17473v1](https://arxiv.org/html/2607.17473v1)
...
### ⭐ Top 4. Evidence-in-the-Loop: Trace-Driven Optimization for Customer-Service LLM Agents

**论文链接**：[https://arxiv.org/abs/2607.18039v1](https://arxiv.org/abs/2607.18039v1) | **HTML全文**：[https://arxiv.org/html/2607.18039v1](https://arxiv.org/html/2607.18039v1)
...
### ⭐ Top 5. Vector Search As Nearest Neighbor Matching: RAG-based Policy Learning in Causal Inference

**论文链接**：[https://arxiv.org/abs/2607.18225v1](https://arxiv.org/abs/2607.18225v1) | **HTML全文**：[https://arxiv.org/html/2607.18225v1](https://arxiv.org/html/2607.18225v1)
